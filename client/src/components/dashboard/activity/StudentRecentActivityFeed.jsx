        ...
        <div className="space-y-2 flex-1 min-h-0 pt-3 pb-1 overflow-y-auto max-h-[190px] pr-1">
          {activities.slice(0, 6).map((item, idx) => {
            ...
            return (
              <div
                key={item.id || idx}
                className="p-2.5 rounded-lg border border-gray-100 dark:border-[#222433] bg-gray-50/40 dark:bg-[#1c1d28]/70 flex items-start gap-2.5 hover:border-gray-300 dark:hover:border-[#2c2f42] transition"
              >
                <div className="mt-0.5 shrink-0 p-1 rounded-md bg-white dark:bg-[#15161e] border border-gray-200/80 dark:border-[#222433] shadow-2xs">
                ...
                <div className="flex-1 min-w-0 space-y-0.5">
                  ...
                  <p className="text-[11px] text-gray-600 dark:text-[#9396a8] leading-snug line-clamp-2">
