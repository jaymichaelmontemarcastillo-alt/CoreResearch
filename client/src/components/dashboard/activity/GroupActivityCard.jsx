...
export const GroupActivityCard = ({ 
  ...
  return (
    <Card className="p-5 sm:p-6 flex flex-col h-full border border-gray-200/90 dark:border-[#222433] bg-white dark:bg-[#15161e] shadow-sm">
      ...
      <div className="space-y-3 border-b border-gray-100 dark:border-[#222433] pb-3 shrink-0">
      ...
      {loading ? (
        ...
        <div className="space-y-3.5 flex-1 min-h-0 pt-4 pb-2 overflow-y-auto max-h-[260px] pr-1">
          {memberStats.map(({ member, count, taskCount, docCount, revisionCount, commentCount }) => {
            ...
            return (
              <div key={member.uid || member.id} className="space-y-1.5">
                ...
                {/* Progress Bar */}
                <div className="w-full h-2 rounded-full bg-gray-100 dark:bg-slate-800/80 overflow-hidden">
                  <div
                ...
                {filter === 'all' && count > 0 && (
                  <div className="flex items-center gap-3 text-[10px] text-gray-400 dark:text-[#6b6f84] pl-8">
      ...
      {/* Footer Disclaimer */}
      <div className="mt-auto pt-3 border-t border-gray-100 dark:border-[#222433] text-[11px] text-gray-400 dark:text-[#6b6f84] flex items-center justify-between shrink-0">
