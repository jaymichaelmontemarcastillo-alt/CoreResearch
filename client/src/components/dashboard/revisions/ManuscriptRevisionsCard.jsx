  ...
  return (
    <Card className="p-5 sm:p-6 flex flex-col h-full border border-gray-200/90 dark:border-[#222433] bg-white dark:bg-[#15161e] shadow-sm">
      ...
      <div className="flex items-center justify-between border-b border-gray-100 dark:border-[#222433] pb-3 shrink-0">
        ...
        {totalRevisions > 0 && (
          <Badge variant={newCount > 0 ? 'amber' : 'emerald'} size="sm">
      ...
      {loading ? (
        ...
        /* Data & Visualization */
        <div className="space-y-4 flex-1 min-h-0 pt-4 pb-2">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="relative flex items-center justify-center shrink-0">
              ...
              <div className="absolute flex flex-col items-center justify-center text-center">
                ...
                <span className="text-[10px] uppercase font-semibold text-gray-400 tracking-wider mt-0.5">
                  Total
                </span>
              </div>
            </div>
            ...
            <div className="flex-1 w-full space-y-2">
              ...
              <button
                ...
                className="w-full p-2.5 rounded-xl border border-amber-200/60 dark:border-amber-900/40 bg-amber-50/40 dark:bg-amber-950/20 hover:bg-amber-100/50 dark:hover:bg-amber-900/30 transition flex items-center justify-between group text-left"
              ...
              >
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <HiArrowTopRightOnSquare className="w-3.5 h-3.5 text-gray-400 group-hover:text-amber-600 dark:group-hover:text-amber-400 transition" />
                </div>
              </button>
              ...
              <button
                ...
                className="w-full p-2.5 rounded-xl border border-emerald-200/60 dark:border-emerald-900/40 bg-emerald-50/40 dark:bg-emerald-950/20 hover:bg-emerald-100/50 dark:hover:bg-emerald-900/30 transition flex items-center justify-between group text-left"
              ...
              >
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <HiArrowTopRightOnSquare className="w-3.5 h-3.5 text-gray-400 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition" />
                </div>
              </button>

              {/* Total Revisions */}
              <div className="px-3 py-1.5 flex items-center justify-between text-xs text-gray-500 dark:text-[#9396a8]">
      ...
      {/* Footer shortcut */}
      {documentId && (
        <div className="mt-auto pt-3 border-t border-gray-100 dark:border-[#222433] flex justify-end shrink-0">
          <button
            type="button"
