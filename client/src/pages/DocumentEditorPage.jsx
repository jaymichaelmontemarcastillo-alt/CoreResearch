...
export const DocumentEditorPage = () => {
    ...
    const loadDocumentData = async () => {
      try {
        ...
        if (isMounted && docData) {
          ...
          // Let Yjs handle the content, or use docData.content (JSON) if it exists. 
          // We DO NOT fallback to docData.contentHtml because it contains auto-generated mock titles which shouldn't be re-injected.
          let contentToLoad = docData.content || null;
  ...
  return (
    <div className={`flex flex-col flex-1 w-full bg-[#f8f9fa] dark:bg-slate-950 overflow-hidden transition-all ${isMaximized
      ...
      <div className="relative flex items-center justify-between px-4 py-2 bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-slate-800 z-50 shrink-0 shadow-sm">
      ...
      {/* Editor Toolbar */}
      {!isFaculty && (
        <div className="relative bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-slate-800 p-1 flex justify-center z-40 shrink-0">
          <EditorToolbar
            editor={editor}
            documentId={documentId}
            onOpenPageSettings={() => setActiveRightPanel('pageSettings')}
